		...
		<div id="main">
			...
			<div id="content">
				...
				<div class="box">
					<!-- Box Head -->
					<div class="box-head">
						<h2 class="left">Manage Questionnaire</h2>
					</div>
					<!-- End Box Head -->	
					...
					<div class="table">
                                                 ...
                                                 <?php 
                                                    ...
                                                    echo "<h3 class='categoryTitle'><a href='exam_management.php'>Category</a> > <a href='sub_category.php?category=$_GET[category]'> $category_title</a> > $subcategory_title </h3>"; 
                                                 ?>
                                                 </div>    
						...
						<!-- Form -->
                                                   <div class="form">
                                                        <input type="hidden" value='<?php echo $subcategoryId ?>' id="subcategoryId" />
						...
						<!-- End Form Buttons -->
                                            ...
                                            <br />
                                            <div id="categoryList">
                                                 <?php echo $componentsCreator->retrieveQuestion($category_id,$subcategoryId); ?>
                                            </div>  
